/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/usr1/compiler_cpu/code/current/build/hcc_arm64le_ark/../../open_source/hcc_arm64le_build_src/gcc-7.3.0/gcc/config/aarch64/aarch64.md'.  */
